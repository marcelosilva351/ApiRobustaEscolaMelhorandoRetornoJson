    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnoEnsinoMedios", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnoEnsinoMedioId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Turmas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Turmas_AnoEnsinoMedios_AnoEnsinoMedioId",
                        column: x => x.AnoEnsinoMedioId,
                        principalTable: "AnoEnsinoMedios",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessoresTurmas_ProfessorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Turmas_AnoEnsinoMedioId",
                table: "Turmas",
                column: "AnoEnsinoMedioId");
        }
